...
class QualityWeatherAdapter(var mCommentQuality: List<CommentQualityModel>? = null) :
    RecyclerView.Adapter<QualityWeatherAdapter.ViewHolder>() {


    inner class ViewHolder(val binding: ItemCommentQualityweatherBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemCommentQualityweatherBinding.inflate(
